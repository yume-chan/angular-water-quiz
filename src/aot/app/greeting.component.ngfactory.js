...
var _View_GrettingComponent0 = (function (_super) {
    ...
    _View_GrettingComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_5 = import4.createRenderElement(this.renderer, this._el_1, 'div', new import4.InlineArray2(2, 'class', 'box round font-small'), null);
        ...
        this._el_10 = import4.createRenderElement(this.renderer, this._el_8, 'h1', new import4.InlineArray4(4, 'class', 'text-center', 'style', 'margin: 0'), null);
        this._text_11 = this.renderer.createText(this._el_10, '浙江省矿联热矿水专委会', null);
        this._text_12 = this.renderer.createText(this._el_8, '\n		', null);
        this._el_13 = import4.createRenderElement(this.renderer, this._el_8, 'h1', new import4.InlineArray4(4, 'class', 'text-center', 'style', 'margin: 0'), null);
