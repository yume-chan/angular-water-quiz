...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __NotFoundGuard_52:import29.NotFoundGuard;
  __AppService_53:import30.AppService;
  __LoginGuard_54:import31.LoginGuard;
  __ViewGuard_55:import32.ViewGuard;
  ...
  get _APP_ID_16():any {
    if ((this.__APP_ID_16 == (null as any))) { (this.__APP_ID_16 = import44._appIdRandomProviderFactory()); }
  ...
  get _EventManager_20():import14.EventManager {
    if ((this.__EventManager_20 == (null as any))) { (this.__EventManager_20 = new import14.EventManager(this._EVENT_MANAGER_PLUGINS_19,this.parent.get(import47.NgZone))); }
  ...
  get _RootRenderer_24():any {
    if ((this.__RootRenderer_24 == (null as any))) { (this.__RootRenderer_24 = import48._createConditionalRootRenderer(this._DomRootRenderer_23,this.parent.get(import48.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_39():any {
    if ((this.__LocationStrategy_39 == (null as any))) { (this.__LocationStrategy_39 = import6.provideLocationStrategy(this.parent.get(import49.PlatformLocation),this.parent.get(import50.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_38)); }
  ...
  get _NotFoundGuard_52():import29.NotFoundGuard {
    if ((this.__NotFoundGuard_52 == (null as any))) { (this.__NotFoundGuard_52 = new import29.NotFoundGuard(this._Router_45)); }
  ...
  get _LoginGuard_54():import31.LoginGuard {
    if ((this.__LoginGuard_54 == (null as any))) { (this.__LoginGuard_54 = new import31.LoginGuard(this._Router_45,this._AppService_53)); }
    return this.__LoginGuard_54;
  }
  get _ViewGuard_55():import32.ViewGuard {
    if ((this.__ViewGuard_55 == (null as any))) { (this.__ViewGuard_55 = new import32.ViewGuard(this._Router_45,this._AppService_53)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_4 = import6.provideForRootGuard(this.parent.get(import58.Router,(null as any)));
    ...
    this._ApplicationRef__13 = new import11.ApplicationRef_(this.parent.get(import47.NgZone),this.parent.get(import59.Console),this,this._ErrorHandler_10,this,this._ApplicationInitStatus_11,this.parent.get(import10.TestabilityRegistry,(null as any)),this._Testability_12);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import60.LOCALE_ID)) { return this._LOCALE_ID_8; }
    if ((token === import8.NgLocalization)) { return this._NgLocalization_9; }
    if ((token === import61.ErrorHandler)) { return this._ErrorHandler_10; }
    ...
    if ((token === import44.APP_ID)) { return this._APP_ID_16; }
    if ((token === import62.DOCUMENT)) { return this._DOCUMENT_17; }
    ...
    if ((token === import63.AnimationDriver)) { return this._AnimationDriver_22; }
    if ((token === import16.DomRootRenderer)) { return this._DomRootRenderer_23; }
    if ((token === import64.RootRenderer)) { return this._RootRenderer_24; }
    if ((token === import17.DomSanitizer)) { return this._DomSanitizer_25; }
    if ((token === import65.Sanitizer)) { return this._Sanitizer_26; }
    if ((token === import18.ViewUtils)) { return this._ViewUtils_27; }
    if ((token === import66.IterableDiffers)) { return this._IterableDiffers_28; }
    if ((token === import67.KeyValueDiffers)) { return this._KeyValueDiffers_29; }
    ...
    if ((token === import70.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_43; }
    if ((token === import71.ROUTES)) { return this._ROUTES_44; }
    if ((token === import58.Router)) { return this._Router_45; }
    if ((token === import72.ActivatedRoute)) { return this._ActivatedRoute_46; }
    ...
    if ((token === import29.NotFoundGuard)) { return this._NotFoundGuard_52; }
    if ((token === import30.AppService)) { return this._AppService_53; }
    if ((token === import31.LoginGuard)) { return this._LoginGuard_54; }
    if ((token === import32.ViewGuard)) { return this._ViewGuard_55; }
